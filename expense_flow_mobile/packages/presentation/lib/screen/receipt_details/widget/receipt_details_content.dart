...
import 'receipt_details_items_list_widget.dart';
import 'receipt_details_merchant_info_widget.dart';
import 'receipt_details_section_widget.dart';
          ...
          child: ReceiptDetailsTransactionInfoWidget(
            ...
            onDateTimeSelected: (dateTime) {
              context.read<ReceiptEditBloc>().add(
                    ReceiptEditEvent.updateTransactionDateTime(dateTime),
                  );
            },
            onTotalChanged: (value) {
              context.read<ReceiptEditBloc>().add(
                    ReceiptEditEvent.updateTotal(value),
                  );
            },
          ),
        ),
        ...
        Expanded(
          child: ReceiptDetailsItemsListWidget(
            ...
            onItemUpdated: (index, updatedItem) {
              final newItems = List<ReceiptItem>.from(widget.receipt.items);
