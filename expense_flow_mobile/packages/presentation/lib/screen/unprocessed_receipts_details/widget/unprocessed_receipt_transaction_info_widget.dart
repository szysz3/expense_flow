...
import 'package:presentation/screen/receipt_details/widget/receipt_details_info_row.dart';
...
class UnprocessedReceiptTransactionInfoWidget extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ReceiptDetailsInfoRow(
            ...
            value: dateFormat.format(receipt.rawData.transactionDatetime),
          ),
          const SizedBox(height: 8),
          ReceiptDetailsInfoRow(
            label: l10n.totalChartData,
            value: currencyFormatter.formatCurrency(receipt.rawData.total),
            isHighlighted: true,
          ),
        ],
      ),
  ...
  void _showDateTimePicker(BuildContext context) async {
    final currentDate = receipt.rawData.transactionDatetime;
